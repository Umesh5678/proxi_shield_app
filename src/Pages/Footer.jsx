        ...
        <div className="container-fluid bg-dark p-5 text-white">
            <div className="row">
               ...
               <div className="col-md-2">
                    <h2>Contact Info</h2>
                    <p className="mt-4"><i class="text-primary fa-solid fa-location-dot"></i> Registered OfficeMYK Arment Private Limited(Formerly Known as, MYK Schomburg India Pvt. Ltd.)8-2-703/A, 3rd Floor, Leela Gopal Towers, Rd No: 12, Banjara Hills Hyderabad – 500 034</p>
               ...
               <div className="col-md-4">
                ...
                <ul>
                    ...
                    <li className="d-inline-block ml-2 mt-3 text-white"><i class="fa-brands fa-whatsapp"></i></li>
                    ...
                    <li className="d-inline-block ml-4 mt-3 text-white"><i class="fa-brands fa-instagram"></i></li>
