            ...
            <div className="row">
                ...
                <div className="header__middle__menus">
                    ...
                    <ul className={boxClass.join(' ')}>
                        ...
                        <li  className="menu-item" >
                            <NavLink exact activeClassName='is-active' onClick={toggleClass} to={`/Company`}> COMPANY </NavLink> 
                        </li>
                        <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> PRODUCTS <FiChevronDown /> </Link>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                <li> <NavLink onClick={toggleClass} activeClassName='is-active'  to={`/Waterproofing`}>Waterproofing </NavLink> </li>
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Flooring`}> Flooring & Coating </NavLink> </li>
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Repair`}> Repair & Joint Sealants </NavLink> </li>                                

                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Grouts`}> Grouts & Anchors </NavLink> </li>

                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Building`}> Building & Joint Seaiats </NavLink> </li>
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Admixture`}> Concrete Admixture  </NavLink> </li>
                        ...
                        <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> APPLICATION <FiChevronDown /> </Link>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                ...
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Flooring`}> Flooring & Coating </NavLink> </li>
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Repair`}> Repair & Joint Sealants </NavLink> </li>                               
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Admixture`}> Admixture & surface Treatments </NavLink> </li>
                        ...
                        <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> DOWNLOADS <FiChevronDown /> </Link>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                <li> <NavLink onClick={toggleClass} activeClassName='is-active'  to={`/Technicaldatasheets`}>Technical Data Sheets </NavLink> </li>
                        ...
                        <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#">SUPPORT <FiChevronDown /> </Link>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                <li> <NavLink onClick={toggleClass} activeClassName='is-active'  to={`/Saleresponsive`}>Sales Representive </NavLink> </li>

                            </ul>
                        </li>
                        <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> MEDIA<FiChevronDown /> </Link>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                <li> <NavLink onClick={toggleClass} activeClassName='is-active'  to={`/Event`}>Events </NavLink> </li>
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Videolib`}>Video Library </NavLink> </li>
